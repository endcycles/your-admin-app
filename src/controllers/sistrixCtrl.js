...
const login = async (req, res) => {
    ...
    try {
        ...
        await page.goto('https://app.sistrix.com/login/', {waitUntil: 'load', timeout: 100000});
        await page.focus("input#username-input").then(async () => {
            await page.keyboard.type(name, { deplay: 100 });
        });
        await page.focus("input#password-input").then(async () => {
